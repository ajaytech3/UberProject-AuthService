...
public class JwtService implements CommandLineRunner {
    ...
    /*
    * This method creates a brand new JWT tokens for us based on tokens
    * */
   ...
   public <T> T extractClaim(String token,Function<Claims, T> claimsResolver){
    ...
    /*
    * This method check if the token expiry is before the current timp stamp or not?
    ...
    * */
    ...
    public void run(String... args) throws Exception {
        ...
        String result=createToken(mp, "ajay");
